...
$pelaporan = "INSERT INTO `pelaporan` (`id_inspektor`, `kode`, `status_apar`) VALUES ('$id_ins', '$kode', '0');";
$proses = mysqli_query($connect, $pelaporan);
} else {
...
$jalankan = mysqli_query($connect, $kondisi);
$pelaporan = "INSERT INTO `pelaporan` (`id_inspektor`, `kode`, `status_apar`) VALUES ('$id_ins', '$kode', '1');";
$proses = mysqli_query($connect, $pelaporan);
}
